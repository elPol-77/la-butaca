...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!empty($errores)) {
        ...
        if ($accion === "crear" && !empty($nombreImagen)) {
            $nuevoId = $peliculasObj->insertarPelicula($titulo, $descripcion, $anio, $duracion, $director_id, $plataforma_id, $nombreImagen, $fecha_estreno);
            if ($nuevoId) {
            ...
            $exito = $peliculasObj->actualizarPelicula($id, $titulo, $descripcion, $anio, $duracion, $director_id, $plataforma_id, $nombreImagen, $fecha_estreno);
            if ($exito) {
...
<head>
    ...
    <style>
        ...
        .genre-checkboxes, .actor-checkboxes {
            display: grid;
        ...
        .genre-checkbox-label, .actor-checkbox-label {
            display: flex;
            align-items: center;
            padding: 8px 12px;
            background: rgba(229, 9, 20, 0.1);
        ...
        .genre-checkbox-label:hover, .actor-checkbox-label:hover {
            background: rgba(229, 9, 20, 0.2);
            border-color: #e50914;
        }
        ...
        .genre-checkbox-text, .actor-checkbox-text {
            color: #fff;
            font-size: 14px;
            user-select: none;
        }
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space: nowrap;">
                                            <a href="peliculas.php?accion=editar&id=<?= $peli['id'] ?>" class="btn-action btn-edit">
                                            ...
                                            <div class="genre-checkboxes">
                                                <?php foreach($listaGeneros as $g): ?>
                                                    <label class="genre-checkbox-label">
                                                        ...
                                                        <span class="genre-checkbox-text"><?= htmlspecialchars($g['nombre']) ?></span>
                                                    </label>
                                                <?php endforeach; ?>
                                            </div>
                                            ...
                                            <div class="actor-checkboxes">
                                                <?php foreach($listaActores as $actor): ?>
                                                    <label class="actor-checkbox-label">
                                                        ...
                                                        <span class="actor-checkbox-text"><?= htmlspecialchars($actor['nombre']) ?></span>
                                                    </label>
                                                <?php endforeach; ?>
                                            </div>
