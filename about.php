...
<?php include 'head.php'; ?>
    ...
    <section class="about-section spad">
        <div class="container">
            ...
            <div class="row" style="margin-top: 50px;">
                <div class="col-lg-12">
                    <div class="about-card">
                        ...
                        <p>
                            La Butaca comenzó como un proyecto personal en 2023, impulsado por la pasión por el cine 
            ...
            <div class="row" style="margin-top: 50px;">
                <div class="col-lg-12">
                    <div class="about-card text-center" style="background: linear-gradient(135deg, #e50914 0%, #c20812 100%); border: none;">
                        <h4 style="color: #fff; margin-bottom: 20px;">¿Listo para Descubrir tu Próxima Película Favorita?</h4>
                        ...
                        <?php else: ?>
                            <a href="peliculas.php" class="btn btn-light btn-lg" style="padding: 12px 40px; font-weight: bold;">
